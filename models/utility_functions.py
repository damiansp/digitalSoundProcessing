...
if sys.platform == "win32":
	...
	print "You won't be able to play sounds, winsound could not be"
        print "imported"
...
def wavread(filename):
    ...
    # scale down and convert audio into floating point number in range of -1
    # to 1
...
def wavplay(filename):
	...
	print "Input file does not exist."
        print "Make sure you computed the analysis/synthesis."
    else:
...
def peakInterp(mX, pX, ploc):
    ...
    returns iploc, ipmag, ipphase: interpolated peak location, magnitude and
    phase values
    """
...
def cleaningTrack(track, minTrackLength=3):
    ...
    track: array of values; minTrackLength: minimum duration of tracks in 
    number of frames
...
def f0Twm(pfreq, pmag, ef0max, minf0, maxf0, f0t=0):
    """
    Function that wraps the f0 detection function TWM, selecting the possible
    f0 candidates and calling the function TWM with them
    ...
    # return 0 if fewer than 3 peaks and not previous f0
